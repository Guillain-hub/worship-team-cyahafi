          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8 md:gap-12 lg:gap-16 mb-8 md:mb-12 lg:mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12 lg:gap-16">
              <div className="flex flex-col gap-3 md:gap-4">
                ...
                <a href="https://www.instagram.com/worshipteamadeprcyahafi?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="text-xs md:text-sm text-purple-200/60 hover:text-pink-500 transition-colors flex items-center gap-2">
